...
def escutar_interface(porta, sock, subrede_local, grafo, interfaces_wan, porta_lan):
    ...
    while True:
        ...
        try:
            ...
            # 2) Pacote vindo da LAN → repassa pela primeira WAN
            if porta == porta_lan:
